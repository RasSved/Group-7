...
class NewWorkTask:
    def __init__(self, workTask: work_tasks.WorkTaskType, tecnicianSystemSlug: str, mowerSystemSlug: str, workTaskId: str, takeWorkUrl: str) -> None:
