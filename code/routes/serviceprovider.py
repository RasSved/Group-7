from flask import Flask, render_template, request, redirect, url_for, Blueprint	# Import the Flask class. An instance of this class will be our WSGI application.
